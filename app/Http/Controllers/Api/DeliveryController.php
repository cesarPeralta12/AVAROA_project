    ...
    public function available(Request $request)
    {
        ...
        $deliveries = $requests->map(function ($driverRequest) use ($now) {
            ...
            return [
                ...
                'pickup_address' => $trip->resolveOriginAddress(),
                'pickup_lat' => (float) $trip->origin_lat,
                'pickup_lng' => (float) $trip->origin_lng,
                'delivery_address' => $trip->resolveDestinationAddress(),
    ...
    public function history(Request $request)
    {
        ...
        $history = $trips->map(function ($trip) {
            return [
                ...
                'status' => $trip->status,
                'origin_address' => $trip->resolveOriginAddress(),
                'origin_url' => $trip->origin_url,
                'destination_address' => $trip->resolveDestinationAddress(),
